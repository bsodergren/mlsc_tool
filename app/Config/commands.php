...
use MLSC\Commands\Set\Command as SetCommand;
...
return new FactoryCommandLoader(
    [
        ...
        'add'    => function () {return new AddCommand(); },
        'update' => function () { return new UpdateCommand(); },
        'delete' => function () { return new DeleteCommand(); },
        'wlan0'  => function () { return new wLan0Command(); },
        'wlan1'  => function () { return new wLan1Command(); },
        'reset'  => function () { return new ResetCommand(); },
        'set'  => function () { return new SetCommand(); },
    ]
);
